...
public class MenuExercActivity extends ActionBarActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_exerc, menu);
        return true;
    }
    ...
    public void btExerc1(View view){
        Intent it = new Intent(MenuExercActivity.this, MemoriaCurta.class);
        startActivity(it);
    }
    public void btExerc2(View view){
        Intent it = new Intent(MenuExercActivity.this, Acelerometro.class);
        startActivity(it);
    }
    public void btExerc3(View view){
        Intent it = new Intent(MenuExercActivity.this, LogicaMatematica.class);
        startActivity(it);
    }
    public void btExerc4(View view){
        Intent it = new Intent(MenuExercActivity.this, Jogomemoria1.class);
        startActivity(it);
    }

    public void btExerc5(View view){
        Intent it = new Intent(MenuExercActivity.this, NumCresc.class);
        startActivity(it);
    }
    public void btExerc6(View view){
        Intent it = new Intent(MenuExercActivity.this, JogoSons.class);
        startActivity(it);
    }
    public void btExerc7(View view){
        Intent it = new Intent(MenuExercActivity.this, Cores.class);
        startActivity(it);
    }
    public void btExerc9(View view){
        Intent it = new Intent(MenuExercActivity.this, JogoSumiu2.class);
        startActivity(it);
    }
    public void btExerc10(View view){
        Intent it = new Intent(MenuExercActivity.this, JogoMaior.class);
        startActivity(it);
    }
    public void btExerc11(View view){
        Intent it = new Intent(MenuExercActivity.this, JogoPergunta.class);
        startActivity(it);
    }
    public void btVRanking(View view){
        Intent it = new Intent(MenuExercActivity.this, VRanking.class);
        startActivity(it);
    }
}
