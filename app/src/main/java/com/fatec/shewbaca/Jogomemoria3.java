...
public class Jogomemoria3 extends ActionBarActivity {

    Random r = new Random();
    TextView lblNum, lblErros, lblResultadoFinal, lblAcertos, lblTime, lblMais1;
    Button btn1,btn2,btn3,btn4,btn5,btn6,btn7,btn8,btn9,btn10,btn11,btn12,btn13,btn14,btn15,btn16,iniciar,btnProximo, btPublicar;
    String numeros=null;
    ...
    int aux=0,cont=0;
    int selec1=0, selec2=0, selec3=0, selec4=0, selec5=0, selec6=0, selec7=0, selec8=0, selec9=0, selec10=0, selec11=0, selec12=0,selec13=0, selec14=0, selec15=0, selec16=0, selecionado=0; //para saber se o botao foi clicado
    int num;//guardar numero randomizado
    private int vetor[] = new int[16];
    //Segundo timer
    private int contT=0;
...
//----------------------------------------------------
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogomemoria3);
        ...
        btn13.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                selecionado++;
                aux=0;
                btn13.setText(String.valueOf(vetor[12]));
                if(selecionado==2){
                    if(Verificar(vetor[12]) == true){
        ...
        btn14.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                selecionado++;
                aux=0;
                btn14.setText(String.valueOf(vetor[13]));
                if(selecionado==2){
                    if(Verificar(vetor[13]) == true){
        ...
        btn15.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                selecionado++;
                aux=0;
                btn15.setText(String.valueOf(vetor[14]));
                if(selecionado==2){
                    if(Verificar(vetor[14]) == true){
        ...
        btn16.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                selecionado++;
                aux=0;
                btn16.setText(String.valueOf(vetor[15]));
                if(selecionado==2){
                    if(Verificar(vetor[15]) == true){
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.jogomemoria3, menu);
        return true;
    }
    ...
    class ranking extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Jogomemoria3.this);
