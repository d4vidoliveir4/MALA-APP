...
public class JogoSumiu2 extends ActionBarActivity {
    public Button b1,b2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogo_sumiu2);
...
// here you can add functions
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_jogo_sumiu2, menu);
        return true;
    }
    ...
    public void btPublicarSumiu(View view){
        new ranking().execute();
    }
    //-----------------------Banco---------------------------------------------------------------------
    class ranking extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(JogoSumiu2.this);
        ...
        protected String doInBackground(String... args) {
            ...
            Enviar e = new Enviar(String.valueOf(pontos),String.valueOf(secs),"9",nome,chave);
            if(e.ranking()==0){
